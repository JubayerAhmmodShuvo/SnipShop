...
const Footer = () => {
  return (
    <>
     <footer className="footer p-20   bg-sky-950 text-white flex flex-col sm:flex-row justify-between items-center ">
  ...
  <div>
    <span className="footer-title">Sell on SnipShop</span> 
  ...
  <div>
    ...
    <a className="link link-hover">Trust & Safety</a> 
          <a className="link link-hover">Privacy Setting</a>
  ...
  <div className="items-center grid-flow-col">
    ...
    <p className='ml-24' > © 2021-2023 SnipShop.com</p>
  </div> 
  <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
     <p className='mr-12' > Terms of use</p>
     <p className='mr-12' > Privacy</p>
     <p className='mr-16' > Interest-based ads</p>
  </div>
      </footer>
    </>
